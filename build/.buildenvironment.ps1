...
$ModuleToBuild = 'PSObjectInspector'

# Project website (used for external help cab file definition) 
# Example: 'https://github.com/zloeber/FormatPowershellCode' 
$ModuleWebsite = 'https://github.com/TheDollarDes/PSObjectInspector'

# Some tags that describe your module. 
# Example: @('Code Formatting', 'Module Creation', 'Build Scripts')
$ModuleTags = @('PowerShell','Debugging','Monitoring Variables', 'Monitoring Objects')

# Module Author
$ModuleAuthor = 'Compilation by Des van Heerden'

# Module Description
$ModuleDescription = 'A Compilation of Powershell Modules for Object Inspection'
